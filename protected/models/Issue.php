...
class Issue extends CActiveRecord {
    //Constant definition for dropdown fields in Issue form
    ...
    public static function getAllowedStatusRange(){
        return array(self::STATUS_NOT_STARTED,  self::STATUS_STARTED,  self::STATUS_FINISHED,);
    }
    ...
    public function getStatusOptions() {
        return array(self::STATUS_NOT_STARTED => 'Not started', self::STATUS_STARTED => 'Started', self::STATUS_FINISHED => 'Finished');
    }
