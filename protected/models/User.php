 ...
 * @property Issue[] $requester_issues
 * @property Issue[] $owner_issues
...
class User extends CActiveRecord {
    ...
    public function relations() {
        ...
        //Names CHANGED !
        return array(
            'requester_issues' => array(self::HAS_MANY, 'Issue', 'requester_id'),
            'owner_issues' => array(self::HAS_MANY, 'Issue', 'owner_id'),
