...
class m130830_142831_create_issue_user_and_assignment_tables extends CDbMigration {
...
//the tbl_project_user_assignment.project_id is a reference to tbl_project.id
        $this->addForeignKey("fk_project_user", "tbl_project_user_ assignment", "project_id", "tbl_project", "id", "CASCADE", "RESTRICT");
